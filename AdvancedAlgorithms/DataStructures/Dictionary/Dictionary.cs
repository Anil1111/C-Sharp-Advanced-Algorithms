...
namespace AdvancedAlgorithms.DataStructures.Dictionary
{
    ...
    public class Dictionary<K, V> : IEnumerable<KeyValuePair<K, V>>
    {
        ...
        /// <param name="initialBucketSize">The larger the bucket size lesser the collision, but memory metters</param>
        public Dictionary(DictionaryType type = DictionaryType.SeparateChaining, int initialBucketSize = 2)
        {
            ...
            {
                //dictionary = new SeperateChainingDictionary<K, V>(initialBucketSize);
            }
            else
            {
        ...
        /// <summary>
        /// Does this dictionary contain the given key
        /// Time complexity: O(1) amortized
        /// </summary>
        /// <param name="key">The key to check</param>
        /// <returns>True if this dictionary contains a given key</returns>
        ...
        /// <summary>
        /// Remove the given key along with it's value
        /// Time complexity: O(1) amortized
        /// </summary>
